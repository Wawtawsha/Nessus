-- Revenue aggregation RPC for time-series charts
-- Aggregates toast_orders by day/week/month for charting
...
COMMENT ON FUNCTION get_revenue_by_period(TEXT, DATE, DATE, UUID) IS
